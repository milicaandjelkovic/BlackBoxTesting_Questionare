...
public class SuccessfulLogOut055 extends BaseTestClass {
    ...
    public void SuccessfulAdministratorLogIn(){
        ...
        LogInPage logInPage1 = administratorPage.clickLogOutButton();
        Assert.assertTrue(logInPage1.verifyLogInPage(), "Url is not right!");
